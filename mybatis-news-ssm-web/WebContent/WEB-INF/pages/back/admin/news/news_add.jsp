...
<%!
	public static final String NEWS_ADD_URL = "pages/back/admin/news/NewsAction!add.action" ;
...
<body>
	<div class="container">
		<div class="row">
			<div class="col-xs-12">
				<form action="<%=NEWS_ADD_URL%>" method="post" class="form-horizontal" id="newsForm" enctype="multipart/form-data">
					<fieldset>
						<legend>
							<label>增加新闻</label>
						</legend>
						...
						<div class="form-group" id="noteDiv">
							...
							<div class="col-md-5">
								<textarea id="note" name="note" class="form-control" placeholder="请编写新闻内容"></textarea>
							</div>
